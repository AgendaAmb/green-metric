        ...
        >
            ...
            <Stack spacing="30px" w="100%" padding="30px" position={"relative"}>
                ...
                <ModuleInput title="6.1.2 Indicar el número de cursos/asignaturas relacionado con la sostenibilidad."
                    elements={[{ text: 'Número de cursos y asignaturas', type: 2, question:'a_6_1_2_1' }, { text: 'Nombre del curso o asignatura', type: 1, question:'a_6_1_2_2' }, { text: 'Nombre del programa educativo', type: 1, question:'a_6_1_2_3' }]} />
            ...
            <Stack spacing="30px" className="column-3" position={"relative"}>
                ...
                <ModuleInput title="6.2.1 Indicar el número de cursos/aginaturas relacionado con la sostenibilidad."
                    elements={[{ text: 'Nombre del evento', type: 2, question:'a_6_2_1_1' }, { text: 'Responsable', type: 1, question:'a_6_2_1_2' }, { evidence: true, maxPhotos: 3 }]} />
            ...
            <Stack spacing="30px" w="100%" padding="30px" className="column-3" position={"relative"}>
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del foro', type: 1, question:'a_6_3_1_1_3' }, { text: "Asistentes", type: 1, question:'a_6_3_1_1_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la rodada', type: 1, question:'a_6_3_1_2_1' }, { text: "Asistentes", type: 1 , question:'a_6_3_1_2_2'}, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la rodada', type: 1, question:'a_6_3_1_2_3'}, { text: "Asistentes", type: 1, question:'a_6_3_1_2_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la feria', type: 1, question:'a_6_3_1_3_1' }, { text: "Asistentes", type: 1, question:'a_6_3_1_3_2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del feria', type: 1, question:'a_6_3_1_3_3' }, { text: "Asistentes", type: 1, question:'a_6_3_1_3_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px" >
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la charla', type: 1, question:'a_6_3_1_4_1' }, { text: "Asistentes", type: 1, question:'a_6_3_1_4_2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la charla', type: 1, question:'a_6_3_1_4_3' }, { text: "Asistentes", type: 1, question:'a_6_3_1_4_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del seminario', type: 1, question:'a_6_3_1_5_1' }, { text: "Asistentes", type: 1, question:'a_6_3_1_5_2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del seminario', type: 1, question:'a_6_3_1_5_3' }, { text: "Asistentes", type: 1, question:'a_6_3_1_5_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px" >
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la conferencia', type: 1, question:'a_6_3_1_6_1' }, { text: "Asistentes", type: 1, question:'a_6_3_1_6_2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la conferencia', type: 1, question:'a_6_3_1_6_3' }, { text: "Asistentes", type: 1, question:'a_6_3_1_6_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Evento', type: 1, question:'a_6_3_1_7_1' }, { text: "Asistentes", type: 1, question:'a_6_3_1_7_2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Evento', type: 1, question:'a_6_3_1_7_3' }, { text: "Asistentes", type: 1, question:'a_6_3_1_7_4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
            ...
            <Stack direction={"row"} gap={6} position={"absolute"} right={"20px"}>
                ...
                <Stack spacing="30px">
                    <ModuleInput title="6.5.1 Número de programas relacionados con la sostenibilidad de su entidad con colaboraciones internacionales"
                        elements={[{ text: 'Número de programas', type: 2, question:'a_6_5_1_1' }, { evidence: true }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.5.1 Número de programas relacionados con la sostenibilidad de su entidad con colaboraciones internacionales"
                        elements={[{ text: 'Número de programas', type: 2, question:'a_6_5_1_2' }, { evidence: true }]} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput title="6.5.3 Cantidad monetaria destinada a proyectos relacionados con la sostenibilidad en los últimos 3 años"
                        elements={[{ text: 'Nombre del proyecto', type: 1, question:'a_6_5_3_1' }, { text: 'Cantidad destinada ($)', type: 6, question:'a_6_5_3_2' }, { text: 'Fuente de recurso', type: 1, question:'a_6_5_3_3' }, { evidence: true }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.5.3 Cantidad monetaria destinada a proyectos relacionados con la sostenibilidad en los últimos 3 años"
                        elements={[{ text: 'Nombre del proyecto', type: 1, question:'a_6_5_3_4' }, { text: 'Cantidad destinada ($)', type: 6, question:'a_6_5_3_5' }, { text: 'Fuente de recurso', type: 1, question:'a_6_5_3_6' }, { evidence: true }]} />
                    <Stack direction={"row"} gap={6} position={"absolute"} right={"20px"}>
