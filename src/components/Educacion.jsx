...
export default function Educacion() {
    ...
    const item = () => {
        const newMod = [...components, { text: 'Nombre del foro', type: 1, question:'a-6-3-1-1-3' }, { text: "Asistentes", type: 1, question:'a-6-3-1-1-4' }, { evidence: true }];
        setComponents([...newMod]);
    }

    const item2 = () => {
        const newMod2 = [...components2,{ text: 'Nombre de la rodada', type: 1, question:'a-6-3-1-2-1' }, { text: "Asistentes", type: 1 , question:'a-6-3-1-2-2'}, { evidence: true }];
        setComponents2([...newMod2]);
    }

    const item3 = () => {
        const newMod3 = [...components3, { text: 'Nombre de la feria', type: 1, question:'a-6-3-1-3-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-3-2' }, { evidence: true }];
        setComponents3([...newMod3]);
    }
    
    const item4 = () => {
        const newMod4 = [...components4, { text: 'Nombre de la charla', type: 1, question:'a-6-3-1-4-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-4-2' }, { evidence: true }];
        setComponents4([...newMod4]);
    }
    const item5 = () => {
        const newMod5 = [...components5, { text: 'Nombre del seminario', type: 1, question:'a-6-3-1-5-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-5-2' }, { evidence: true }];
        setComponents5([...newMod5]);
    }

   
    const item6 = () => {
        const newMod6 = [...components6,{ text: 'Nombre de la conferencia', type: 1, question:'a-6-3-1-6-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-6-2' }, { evidence: true }];
    ...
    const item8 = () => {
        const newMod8 = [...components8,{ text: 'Número de programas', type: 2, question:'a-6-5-1-1' }, { evidence: true }];
        setComponents8([...newMod8]);
    }
    
    const item9 = () => {
        const newMod9 = [...components9,{ text: 'Nombre del proyecto', type: 1, question:'a-6-5-3-4' }, { text: 'Cantidad destinada ($)', type: 6, question:'a-6-5-3-5' }, { text: 'Fuente de recurso', type: 1, question:'a-6-5-3-6' }, { evidence: true }];
        setComponents9([...newMod9]);
    }
    const item10 = () => {
        const newMod10 = [...components10,{ text: 'Nombre del curso o asignatura', type: 1, question:'a-6-1-2-2' }, { text: 'Nombre del programa educativo', type: 1, question:'a-6-1-2-3' }];
        setComponents10([...newMod10]);
    }
    const item11 = () => {
        const newMod11 = [...components11,{ text: 'Nombre del evento', type: 2, question:'a-6-2-1-1' }, { text: 'Responsable', type: 1, question:'a-6-2-1-2' }, { evidence: true, maxPhotos: 3 }];
        ...
        >
            ...
            <Stack spacing="30px" w="100%" padding="30px" position={"relative"}>
                ...
                <ModuleInput title="6.1.1 Números de cursos/asignaturas totales, contenidos en el plan curricular de cada programa educativo que ofrece la entidad."
                    elements={[{ type: 2, question:'a-6-1-1' }]} />
                ...
                <ModuleInput title="6.1.2 Indicar el número de cursos/asignaturas relacionado con la sostenibilidad."
                    elements={[{ text: 'Número de cursos y asignaturas', type: 2, question:'a-6-1-2-1' }, { text: 'Nombre del curso o asignatura', type: 1, question:'a-6-1-2-2' }, { text: 'Nombre del programa educativo', type: 1, question:'a-6-1-2-3' }]} />
                ...
                <ModuleInput title="6.1.3 Número de alumnos que tomaron materias ambientales y sostenibilidad."
                    elements={[{ type: 2, question:'a-6-1-3' }]} />
            </Stack>
            ...
            <Stack spacing="30px" className="column-3" position={"relative"}>
                ...
                <ModuleInput title="6.2.1 Indicar el número de cursos/aginaturas relacionado con la sostenibilidad."
                    elements={[{ text: 'Nombre del evento', type: 2, question:'a-6-2-1-1' }, { text: 'Responsable', type: 1, question:'a-6-2-1-2' }, { evidence: true, maxPhotos: 3 }]} />
            ...
            <Stack spacing="30px" w="100%" padding="30px" className="column-3" position={"relative"}>
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del foro', type: 1, question:'a-6-3-1-1-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-1-2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del foro', type: 1, question:'a-6-3-1-1-3' }, { text: "Asistentes", type: 1, question:'a-6-3-1-1-4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la rodada', type: 1, question:'a-6-3-1-2-1' }, { text: "Asistentes", type: 1 , question:'a-6-3-1-2-2'}, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la rodada', type: 1, question:'a-6-3-1-2-3'}, { text: "Asistentes", type: 1, question:'a-6-3-1-2-4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la feria', type: 1, question:'a-6-3-1-3-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-3-2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del feria', type: 1, question:'a-6-3-1-3-3' }, { text: "Asistentes", type: 1, question:'a-6-3-1-3-4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px" >
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la charla', type: 1, question:'a-6-3-1-4-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-4-2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la charla', type: 1, question:'a-6-3-1-4-3' }, { text: "Asistentes", type: 1, question:'a-6-3-1-4-4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del seminario', type: 1, question:'a-6-3-1-5-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-5-2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del seminario', type: 1, question:'a-6-3-1-5-3' }, { text: "Asistentes", type: 1, question:'a-6-3-1-5-4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px" >
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la conferencia', type: 1, question:'a-6-3-1-6-1' }, { text: "Asistentes", type: 1, question:'a-6-3-1-6-2' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de la conferencia', type: 1, question:'a-6-3-1-6-3' }, { text: "Asistentes", type: 1, question:'a-6-3-1-6-4' }, { evidence: true }]} inputLarge={true} />
                </Stack>
                <Stack spacing="30px">
            ...
            <Stack spacing="30px" w="100%" padding="30px" className="column-3">
                ...
                <Stack spacing="30px">
                    <ModuleInput title="6.4.1 Indica el nombre de la publicación, autor (es) y lugar donde se publicó."
                        elements={[{ text: 'Nombre de la publicación', type: 1, question:'a-6-4-1-1-1' }, { text: 'Autor(es)', type: 1, question:'a-6-4-1-1-2' }, { text: 'Sitio de publicación', type: 1, question:'a-6-4-1-1-3' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.4.1 Indica el nombre de la publicación, autor (es) y lugar donde se publicó."
                        elements={[{ text: 'Nombre de la publicación', type: 1, question:'a-6-4-1-2-1' }, { text: 'Autor(es)', type: 1, question:'a-6-4-1-2-2' }, { text: 'Sitio de publicación', type: 1, question:'a-6-4-1-2-3' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.4.1 Indica el nombre de la publicación, autor (es) y lugar donde se publicó."
                        elements={[{ text: 'Nombre de la publicación', type: 1, question:'a-6-4-1-3-1' }, { text: 'Autor(es)', type: 1 , question:'a-6-4-1-3-2'}, { text: 'Sitio de publicación', type: 1, question:'a-6-4-1-3-4' }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.4.2 Indica el número de tesis generadas sobre temas relacionados con la sostenibilidad."
                        elements={[{ type: 2, question:'a-6-4-2-1' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.4.2 Indica el número de tesis generadas sobre temas relacionados con la sostenibilidad."
                        elements={[{ type: 2, question:'a-6-4-2-2' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.4.2 Indica el número de tesis generadas sobre temas relacionados con la sostenibilidad."
                        elements={[{ type: 2, question:'a-6-4-2-3' }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.4.3 Indica las agrupaciones que persiguen un objetivo relacionado con la sostenibilidad."
                        elements={[{ text: 'Nombre de agrupación', type: 1, question:'a-6-4-3-1-1' }, { text: ' Objetivo de agrupacion', type: 1, question:'a-6-4-3-1-2' }, { text: 'Integrantes', type: 2, question:'a-6-4-3-1-3' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.4.3 Indica las agrupaciones que persiguen un objetivo relacionado con la sostenibilidad."
                        elements={[{ text: 'Nombre de agrupación', type: 1, question:'a-6-4-3-2-1' }, { text: ' Objetivo de agrupacion', type: 1, question:'a-6-4-3-2-2' }, { text: 'Integrantes', type: 2, question:'a-6-4-3-2-3'}]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.4.3 Indica las agrupaciones que persiguen un objetivo relacionado con la sostenibilidad."
                        elements={[{ text: 'Nombre de agrupación', type: 1, question:'a-6-4-3-3-1' }, { text: ' Objetivo de agrupacion', type: 1, question:'a-6-4-3-3-2' }, { text: 'Integrantes', type: 2, question:'a-6-4-3-3-3' }]} />
                </Stack>
            </Stack>
            <Stack spacing="30px" w="100%" padding="30px" className="column-3" position={"relative"}>
            <Stack direction={"row"} gap={6} position={"absolute"} right={"20px"}>
                ...
                <Stack spacing="30px">
                    <ModuleInput title="6.5.1 Número de programas relacionados con la sostenibilidad de su entidad con colaboraciones internacionales"
                        elements={[{ text: 'Número de programas', type: 2, question:'a-6-5-1-1' }, { evidence: true }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.5.1 Número de programas relacionados con la sostenibilidad de su entidad con colaboraciones internacionales"
                        elements={[{ text: 'Número de programas', type: 2, question:'a-6-5-1-2' }, { evidence: true }]} />
                </Stack>
                <Stack spacing="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput title="6.5.2 Fondos de investigación totales de los últimos 3 años."
                        elements={[{ helper: 'Esta información se utilizará para calcular el porcentaje de financiación de la investigación sobre el medio ambiente y la sostenibilidad con respecto a la financiación total de la investigación.' }, { text: '2020', type: 2, question:'a-6-5-2-1' }, { evidence: true }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.5.2 Fondos de investigación totales de los últimos 3 años."
                        elements={[{ helper: 'Esta información se utilizará para calcular el porcentaje de financiación de la investigación sobre el medio ambiente y la sostenibilidad con respecto a la financiación total de la investigación.' }, { text: '2021', type: 2, question:'a-6-5-2-2' }, { evidence: true }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.5.2 Fondos de investigación totales de los últimos 3 años."
                        elements={[{ helper: 'Esta información se utilizará para calcular el porcentaje de financiación de la investigación sobre el medio ambiente y la sostenibilidad con respecto a la financiación total de la investigación.' }, { text: '2022', type: 2, question:'a-6-5-2-3' }, { evidence: true }]} />
                </Stack>
                ...
                <Stack spacing="30px">
                    <ModuleInput title="6.5.3 Cantidad monetaria destinada a proyectos relacionados con la sostenibilidad en los últimos 3 años"
                        elements={[{ text: 'Nombre del proyecto', type: 1, question:'a-6-5-3-1' }, { text: 'Cantidad destinada ($)', type: 6, question:'a-6-5-3-2' }, { text: 'Fuente de recurso', type: 1, question:'a-6-5-3-3' }, { evidence: true }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.5.3 Cantidad monetaria destinada a proyectos relacionados con la sostenibilidad en los últimos 3 años"
                        elements={[{ text: 'Nombre del proyecto', type: 1, question:'a-6-5-3-4' }, { text: 'Cantidad destinada ($)', type: 6, question:'a-6-5-3-5' }, { text: 'Fuente de recurso', type: 1, question:'a-6-5-3-6' }, { evidence: true }]} />
                    <Stack direction={"row"} gap={6} position={"absolute"} right={"20px"}>
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del grupo', type: 1, question:'a-6-5-5-1' }, { text: 'Objetivo', type: 1, question:'a-6-5-5-2' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del grupo', type: 1, question:'a-6-5-5-3' }, { text: 'Objetivo', type: 1, question:'a-6-5-5-4' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre del grupo', type: 1, question:'a-6-5-5-5' }, { text: 'Objetivo', type: 1, question:'a-6-5-5-6' }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.5.6 Número total de estudiantes regulares" elements={[{ type: 2, question:'a-6-5-6' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.5.7 Número total de estudiantes que trabajan en línea" elements={[{ type: 2, question:'a-6-5-7' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.5.8 Número total de personal académico y administrativo" elements={[{ type: 2, question:'a-6-5-8' }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="6.5.9 Número total de grupos estudiantiles, o independientes que fomenten acciones en pro de la sostenibilidad. (clubes, organizaciones no gubernamentales, sindicatos, grupos, etc)" elements={[{ type: 2, question:'a-6-5-9' }, { evidence: true }]} />
                </Stack>

                <Stack spacing="30px">
                    <ModuleInput title="6.5.10 Número total de empresas o emprendimientos que han surgido en su entidad con productos o proyectos sostenibles" elements={[{ type: 2, question:'a-6-5-10' }, { evidence: true }]} />
                </Stack>
            </Stack>
