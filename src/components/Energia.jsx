    ...
    return(
        ...
        >
            ...
            <Stack spacing="30px" w="100%" padding="30px" className="column-3">
                ...
                <Stack spacing="30px">
                    <ModuleInput title="Iluminación" elements={[{text: '2.1.1 Descarga de alta intensidad', type:2, question:'2-1-1'}, 
                    {text:'2.1.2 LED', type:2, question:'2-1-2'}, {text:'2.1.3 Fluorescente', type:2, question:'2-1-3'}, {text:'2.1.4 Inducción', type:2, question:'2-1-4'}, {evidence:true, maxPhotos:3}]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="Refrigeradores" elements={[{text: '2.1.5 Convencional', type:2 , question:'2-1-5'}, 
                    {text:'2.1.6 De alta eficiencia', type:2, question:'2-1-6'}, {text:'2.1.7 De laboratorio', type:2, question:'2-1-7'},{evidence:true, maxPhotos:3}]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="Generadores eléctricos" elements={[
                    {text: '2.1.8 Generador inverter', type:2, question:'2-1-8'}, 
                    {text:'2.1.9 Generador por condensador', type:2, question:'2-1-9'}, {text:'2.1.10 Generador por regulador electrónico', type:2, question:'2-1-10'},{evidence:true, maxPhotos:3}]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="Aire acondicionado" elements={[
                    {text: '2.1.11 Convencional', type:2, question:'2-1-11'}, 
                    {text:'2.1.12 Con tecnología inverter', type:2, question:'2-1-12'}, {text:'2.1.13 Aire lavado', type:2, question:'2-1-13'},{evidence:true, maxPhotos:3}]} />
                </Stack>
            </Stack>
            ...
            <Stack w="100%" direction={"row"} divider={<StackDivider borderColor="gray.200" />}>
                <Stack spacing="30px">
                    <ModuleInput elements={[{text: 'Tipo de energía renovable', type:1, question:'2-2-1-1'}, 
                    {text:'Cantidad de equipos', type:2, question:'2-2-1-2'}, {text:'Capacidad de kW/h', type:2, question:'2-2-1-3'}, {evidence:true, maxPhotos:1}]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{text: 'Tipo de energía renovable', type:1, question:'2-2-1-4'}, 
                    {text:'Cantidad de equipos', type:2, question:'2-2-1-5'}, {text:'Capacidad de kW/h', type:2, question:'2-2-1-6'}, {evidence:true, maxPhotos:1}]} />
                </Stack>
                <Stack spacing="30px">
            ...
            <h4 className="expand-2 blue">2.2.4 Número de programas de innovación en energía y cambio climático (Implementación de programas de seguridad energética, programas de ahorro de energía, programa de eficiencia energética, sosteibilidd energética, etc).</h4>
                <Stack spacing="30px">
                    <ModuleInput elements={[{type:2, question:'2-2-4'}, {evidence:true, maxPhotos:3}]} />
                 </Stack>
            </Stack>
            ...
            <Stack spacing="30px">
                <ModuleInput title="2.2.5.1 3R (Reducir, Reusar, Reciclar)" elements={[{dicotomic:true, span:true, questionDicotomic:'2-2-5-1'}]} />
                <ModuleInput select={[
                ...
                <Stack spacing="30px">
                <ModuleInput title="2.2.5.2 Programa de seguridad energética" elements={[{dicotomic:true, span:true, questionDicotomic:'2-2-5-2'}]} />
                <ModuleInput select={[
                "Sin programa implementado",
                "Programa en preparación",
                "Capacitación y material educativo a nivel local",
                ...
                <Stack spacing="30px">
                <ModuleInput title="2.2.5.3 Mitigación de cambio climático" elements={[{dicotomic:true, span:true, questionDicotomic:'2-2-5-3'}]} />
                <ModuleInput select={[
                "Sin programa implementado",
                "Programa en preparación",
                "Capacitación y material educativo a nivel local",
                ...
                <Stack spacing="30px">
                <ModuleInput title="2.2.5.4 Reducción del uso de papel y plástico" elements={[{dicotomic:true, span:true, questionDicotomic:'2-2-5-4'}]} />
                <ModuleInput select={[
                "Sin programa implementado",
                "Programa en preparación",
                "Capacitación y material educativo a nivel local",
