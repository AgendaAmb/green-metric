...
export default function Energia() {
    ...
    const item2 = () => {
        ...
        { text: 'Institución que lo valida', type: 1, question: `a_2_2_2_1_${politics}_2` }, { evidence: true, maxPhotos: 3 }];
        ...
        >
            ...
            <Stack spacing="30px" w="100%" padding="30px" className="column-3">
                ...
                <Stack spacing="30px">
                    ...
                    { text: '2.1.2 LED', type: 2, question: 'a_2_1_2' }, { text: '2.1.3 Fluorescente', type: 2, question: 'a_2_1_3' }, { text: '2.1.4 Inducción', type: 2, question: 'a_2_1_4' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="Refrigeradores" elements={[{ text: '2.1.5 Convencional', type: 2, question: 'a_2_1_5' },
                    { text: '2.1.6 De alta eficiencia', type: 2, question: 'a_2_1_6' }, { text: '2.1.7 De laboratorio', type: 2, question: 'a_2_1_7' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="Generadores eléctricos" elements={[
                        { text: '2.1.8 Generador inverter', type: 2, question: 'a_2_1_8' },
                        { text: '2.1.9 Generador por condensador', type: 2, question: 'a_2_1_9' }, { text: '2.1.10 Generador por regulador electrónico', type: 2, question: 'a_2_1_10' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput title="Aire acondicionado" elements={[
                        { text: '2.1.11 Convencional', type: 2, question: 'a_2_1_11' },
                        { text: '2.1.12 Con tecnología inverter', type: 2, question: 'a_2_1_12' }, { text: '2.1.13 Aire lavado', type: 2, question: 'a_2_1_13' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
            </Stack>
            ...
            <Stack spacing="30px" w="100%" className="column" position={"relative"}>
                ...
                <Stack w="100%" direction={"row"} divider={<StackDivider borderColor="gray.200" />}>
                    <Stack spacing="30px">
                        ...
                        { text: 'Cantidad de equipos', type: 2, question: 'a_2_2_1_1_2' }, { text: 'Capacidad de kW/h', type: 2, question: 'a_2_2_1_1_3' }, { evidence: true, maxPhotos: 1 }]} />
                    </Stack>
                    <Stack spacing="30px">
                        <ModuleInput elements={[{ text: 'Tipo de energía renovable 2', type: 1, question: 'a_2_2_1_2_1' },
                        { text: 'Cantidad de equipos', type: 2, question: 'a_2_2_1_2_2' }, { text: 'Capacidad de kW/h', type: 2, question: 'a_2_2_1_2_3' }, { evidence: true, maxPhotos: 1 }]} />
                    </Stack>
                    <Stack spacing="30px">
                        <ModuleInput elements={[{ text: 'Tipo de energía renovable 3', type: 1, question: 'a_2_2_1_3_1' },
                        { text: 'Cantidad de equipos', type: 2, question: 'a_2_2_1_3_2' }, { text: 'Capacidad de kW/h', type: 2, question: 'a_2_2_1_3_3' }, { evidence: true, maxPhotos: 1 }]} />
                    </Stack>
            ...
            <Stack spacing="30px" w="100%" padding="30px" className="column-3" position={"relative"}>
                ...
                <Stack spacing="30px">
                    ...
                    { text: 'Institución que lo valida', type: 1, question: 'a_2_2_2_1_2' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
                <Stack spacing="30px">
                    <ModuleInput elements={[{ text: 'Nombre de política 2', type: 1, question: 'a_2_2_2_2_1' },
                    { text: 'Institución que lo valida', type: 1, question: 'a_2_2_2_2_2' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
                <Stack spacing="30px">
            ...
            <Stack spacing="30px" w="100%" padding="30px">
                ...
                <Stack spacing="30px">
                    <ModuleInput elements={[{ type: 2, question: 'a_2_2_4' }, { evidence: true, maxPhotos: 3 }]} />
                </Stack>
            </Stack>
