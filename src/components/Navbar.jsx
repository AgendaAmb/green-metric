        ...
        <div className="navbar">
            ...
            <Link href="/infraestructura/">
                <Box w="100%" bgColor={"#008037"}>
                    <Image src="/GreenMetric/edificio.png"/>
                    <h3>Entorno e Infraestructura</h3>
                </Box>
            </Link>
            <Link href="/energia/">
                <Box w="100%" bgColor={"#cfaf2e"}>
                    <Image src="/GreenMetric/climatico.png"/>
            ...
            <Link href="/residuos/">
                ...
                <Box w="100%" bgColor={"#e09d9a"}>
                    <Image src="/GreenMetric/basura.png"/>
                    <h3>Gestión de Residuos</h3>
                </Box>
            </Link>
            <Link href="/agua/">
                <Box w="100%" bgColor={"#5271ff"}>
                    <Image src="/GreenMetric/agua.png"/>
                    <h3>Uso de Agua</h3>
                </Box>
            </Link>
            <Link href="/transporte/">
                <Box w="100%" bgColor={"#ff1616"}>
                    <Image src="/GreenMetric/transporte.png"/>
                    <h3>Transporte</h3>
                </Box>
            </Link>
            <Link href="/educacion/">
                <Box w="100%" bgColor={"#ff914d"}>
                    <Image src="/GreenMetric/investigacion.png"/>
