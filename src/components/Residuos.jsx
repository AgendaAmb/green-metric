    ...
    return (
        ...
        >
            ...
            <h3 className="expand-2 green">3.1 Cantidad de residuos sólidos urbanos (RSU).</h3>
                <ModuleInput elements={[{ text: "3.1.1 Indicar la cantidad de RSU en kg, que se recolectan por semana", type: 4, question:'3-1-1' }, { text: "3.1.2 Indicar el porcentaje de estos RSU que son valorizados para su reciclaje.", type: 3, question:'3.1.2' }]} />
            </Stack>
            <Stack spacing="30px" w="100%" className="column-2" padding="30px">
            <h3 className="expand-2 green">3.2 Cantidad (kg) de residuos orgánicos.</h3>
                <ModuleInput elements={[{
                    ...
                    , evidence: true, maxPhotos: 3, question:'3-2-1'
                ...
                <ModuleInput elements={[{
                    text: "3.2.3.1 ¿Cuenta con un programa de tratamiento de residuos orgánicos?", type: 4, dicotomic: true, questionDicotomic:'3-2-3-1', vertical: true
                }, { text: "3.2.3.2 Nombre del programa implementado", holder: "Nombre del programa", type: 1, question:'3-2-3-2', vertical: true, span: false}]}/>
            ...
            <h3 className="expand-2 green">
                ...
                <ModuleInput elements={[{ text: "3.4.1 Cantidad de residuos inorgánicos producidos por semana (kg).", type: 2, evidence: true, maxPhotos: 3, question:'3-4-1' }, { text: "3.4.2 Cantidad de residuos inorgánicos procesados por semana (separados, recuperados, reciclados, etc (kg)).", type: 2, evidence: true, maxPhotos: 3, question:'3-4-2' }]}/>

                <ModuleInput elements={[{ text: "3.4.3.1 ¿Cuenta con un programa de tratamiento de residuos inorgánicos?", dicotomic: true, questionDicotomic:'3-4-3-1'}, { text: "3.4.3.2 Nombre del programa implementado", type: 1, holder: "Nombre del programa", question:'3-4-3-2' }, { text: "3.4.3.3 Indicar el porcentaje de residuos inorgánicos que son tratados con el programa.", type: 3, question:'3-4-3-3' }, { evidence: true, span: true, maxPhotos: 3 }]} title={"3.4.3 Porcentaje de implementación de programa(s) para tratamiento de residuos inorgánicos."} />
            ...
            <h3 className="expand-2 green">
                ...
                <ModuleInput elements={[{ type: 2, holder: "Total de programas", evidence: true, span: true, maxPhotos: 3, question:'3-6' }]} />
            </Stack>
            <Stack spacing="30px" w="100%" className="column-2" padding="30px">
            <h3 className="expand-2 green">
                ...
                <ModuleInput elements={[{ type: 4, evidence: true, span: true, maxPhotos:3 , question:'3-7'}]} />
