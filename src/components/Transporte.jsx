...
export default function Transporte() {
    return (
        ...
        <Stack spacing="30px" w="100%"   padding="30px">
            <h2 className="blue">5.2 Número de servicios de transporte destinado a trabajadores y alumnos</h2>
        ...
        <Stack spacing="30px" w="100%"   padding="30px">
        <h2 className="blue">5.4 Área total en m2 de estacionamiento en su entidad.</h2>
        ...
        <Stack spacing="30px" w="100%" padding="30px" direction="column">
            <h2 className="blue">5.5 Iniciativas para disminuir, uso de áreas de estacionamiento, los vehículos privados en el campus.</h2>
        ...
        <Stack spacing="30px" w="100%" padding="30px" direction="column">
            <h2 className="blue">5.6 Número de pasos peatonales y su extensión (m2).</h2>
        ...
        <Stack spacing="30px" w="100%"   padding="30px">
        <h2 className="blue">5.7 Área total en m2 de estacionamiento asegurado para transporte multimodal (Infra, recoleccón de residuos, gruas, bomberos, ambulancias, etc).</h2>
            <ModuleInput
                elements={[{type:5}]} /> 
            </Stack>
