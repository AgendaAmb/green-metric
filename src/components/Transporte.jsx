    ...
    return (
        ...
        <Stack spacing="30px" w="100%"   padding="30px">
            ...
            <ModuleInput title="5.1.1 Indica el número de vehículos oficiales con los que cuenta su entidad"
                elements={[{type:2, question:'5-1-1'}]} /> 
            ...
            {text:'5.1.2.1 Total de autos ingresados', type:2, question:'5-1-2-1'}, {text:'5.1.2.2 Autos híbridos', type:2, question:'5-1-2-2'}, {text:'5.1.2.3 Vehículos de combustible', type:2, question:'5-1-2-3'}]} />
            <ModuleInput title="5.1.3 Indicar el número de motocicletas que ingresan diariamente"
                elements={[{type:2, question:'5-1-3'}]} /> 
        </Stack>

        <Stack spacing="30px" w="100%"   padding="30px">
            <h2 className="green">5.2 Número de servicios de transporte destinado a trabajadores y alumnos</h2>
            <ModuleInput elements={[ 
            {text:'5.2.1 Su entidad cuenta con un servicio de transporte de personal o de alumnado', type:2, question:'5-2-1'}, {text:'5.2.2 Rutas de transporte público que transitan cerca de su entidad', type:2, question:'5-2-2'}, {text:'5.2.3 Número de viajes por día', type:2, question:'5-2-3'}, {text:'5.2.4 Personas que hacen uso del transporte publico', type:2, question:'5-2-4'}]} />
        </Stack>
        ...
        <Stack spacing="30px" w="100%"   padding="30px">
            ...
            <ModuleInput elements={[ 
            {text:'5.3.1 Bicicletas', type:2, question:'5-3-1'}, {text:'5.3.2 Patinetas', type:2, question:'5-3-2'}, {text:'5.3.3 Carros eléctricos', type:2, question:'5-3-3'}, {text:'5.3.4 Otros', type:2, question:'5-3-4'}]} />
        </Stack>

        <Stack spacing="30px" w="100%"   padding="30px">
        <h2 className="green">5.4 Área total en m2 de estacionamiento en su entidad.</h2>
            <ModuleInput elements={[{type:5, question:'5-4'}]} /> 
        ...
        <Stack spacing="30px" w="100%" padding="30px" direction="column">
            ...
            {type:1, evidence: true, question:'5-5-1'}, {type:1, evidence: true, question:'5-5-2'}, {type:1, evidence: true, question:'5-5-3'}, {type:1, evidence: true, question:'5-5-4'}, ]} />
        </Stack>
        ...
        <Stack spacing="30px" w="100%" padding="30px" direction="column">
            ...
            elements={[{type: 2, helper:'Número de pasos peatonales', question:'5-6-1'}, {type:5, helper:'Área de extensión', question:'5-6-2'}, {evidence:true}]}/>
        </Stack>
